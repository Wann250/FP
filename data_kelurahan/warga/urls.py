...
from .views import WargaListView, WargaDetailView, WargaUpdateView, WargaDeleteView, PengaduanListView, WargaCreateView, PengaduanCreateView, PengaduanUpdateView, PengaduanDeleteView
